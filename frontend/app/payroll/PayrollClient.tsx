      ...
      >
        <div className="relative h-64 md:h-96 overflow-hidden rounded-lg">
          ...
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">Tej Payroll</h1>
              ...
              >
                <Link
                  href="/contact"
                  className="inline-block bg-gradient-to-r from-orange-500 to-red-500 text-white px-8 py-3 rounded-full shadow-lg hover:from-orange-600 hover:to-red-600 hover:shadow-xl transition-all"
                >
                  Request a Free Demo
                </Link>
              </motion.div>
