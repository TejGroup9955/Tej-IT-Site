...
export default function SoftwareDevelopmentPage() {
  ...
  const imageVariants: Variants = {
    hidden: { scale: 1.1 },
    visible: { scale: 1, transition: { duration: 10, repeat: Infinity, repeatType: 'reverse' } },
  };
  ...
  return (
    <div className="bg-gradient-to-br from-teal-50 via-white to-purple-50 min-h-screen font-sans text-gray-900">
      ...
      <motion.section
        ...
        className="relative py-28 md:py-36 overflow-hidden h-[70vh] max-h-[800px]"
      >
        ...
        >
          <Image
            src="/it-services/software-hero-optimized.jpg"
            ...
            {services.map((service, _) => (
              ...
              >
                <motion.div
                  ...
                  transition={{ duration: 0.4, times: [0, 0.2, 0.4, 0.6, 0.8, 1], repeat: Infinity, repeatDelay: 3 }}
                >
