...
export default function WebAppDesignDevelopmentPage() {
  ...
  const iconShakeVariants: Variants = {
    rest: { x: 0 },
    hover: {
      x: [-5, 5, -5, 5, 0], // Shake effect by moving left-right
      transition: {
        x: { repeat: 1, duration: 0.4, ease: 'easeInOut' }, // Short shake animation
      },
    },
  };
    ...
    <div className="bg-gradient-to-br from-purple-50 via-white to-blue-50 min-h-screen font-sans text-gray-900">
      ...
      >
        ...
        <div className="absolute inset-0">
          <Image
            src="/it-services/web-design-hero.jpg"
            alt="Web Design Hero"
            layout="fill"
            objectFit="cover"
